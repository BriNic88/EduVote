...
import { Vote, LayoutDashboard, CalendarClock, CalendarCheck, Vote as VoteIcon, Trophy, User, LogOut, Menu } from "lucide-react";
...
const navItems = [
  ...
  { href: "/student/upcoming", label: "Upcoming Elections", icon: CalendarClock },
  { href: "/student/live", label: "Live Elections", icon: CalendarCheck },
  { href: "/student/vote", label: "Cast Vote", icon: VoteIcon },
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground truncate">{user?.className}</p>
          </div>
        </div>
        <Button
          variant="ghost"
